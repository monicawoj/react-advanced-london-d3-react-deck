...
<div style={{ backgroundImage: `url(${require("file-loader!./images/boring_chart.gif")})`,
    backgroundSize: 'contain',
    width: '40vw',
    height: '40vh',
    backgroundPosition: 'center',
...
>
  <div
    style={{
      backgroundImage: `url(${require("file-loader!./images/salt-shaker.png")})`,
      backgroundSize: "contain",
      width: "350px",
      height: "350px",
      backgroundPosition: "center",
...
>
  ...
  <div
    style={{
      backgroundImage: `url(${require("file-loader!./images/A_to_B.gif")})`,
      backgroundSize: "contain",
      width: "60vw",
      height: "60vw",
      backgroundPosition: "center",
...
>
  ...
  <div
    style={{
      backgroundImage: `url(${require("file-loader!./images/a1_to_a2.gif")})`,
      backgroundSize: "contain",
      width: "60vw",
      height: "60vw",
      backgroundPosition: "center",
...
>
  ...
  <div
    style={{
      backgroundImage: `url(${require("file-loader!./images/a_t.gif")})`,
      backgroundSize: "contain",
      width: "60vw",
      height: "60vw",
      backgroundPosition: "center",
...
>
  ...
  <div
    style={{
      backgroundImage: `url(${require("file-loader!./images/ah_look_here.gif")})`,
      backgroundSize: "contain",
      width: "60vw",
      height: "60vw",
      backgroundPosition: "center",
