...
<div style={{ fontSize: "1.5em", position: "relative", bottom: "-20%" }}>
  <RotateLoopingText><h1 className="title">Hooked on D3</h1></RotateLoopingText>
  <h2>
    Creating <ColorLoopingText>Animated</ColorLoopingText> Ch(art)s with D3 and
    React Hooks
  </h2>
</div>
<div
...
<h1>
  <Disappear
    ...
    elementsToRemove={[<span>Time and Change</span>]}
  />
</h1>
...
<div
  style={{
    ...
    top: "25%",
    backgroundSize: "contain",
    backgroundImage: "url(./images/react_with_hat.png)",
    backgroundPosition: "center",
    backgroundRepeat: "no-repeat"
  }}
/>
...
<div
  style={{
    ...
    top: "25%",
    backgroundSize: "contain",
    backgroundImage: "url(./images/d3_with_hat.png)",
    backgroundPosition: "center",
    backgroundRepeat: "no-repeat"
  }}
/>
  ...
  <Appear>
    <div
      style={{
        ...
        height: "50%",
        backgroundSize: "contain",
        backgroundImage: "url(./images/react_chef.png)",
        backgroundPosition: "center",
        backgroundRepeat: "no-repeat"
      }}
    />
    <div
      style={{
        ...
        height: "50%",
        backgroundSize: "contain",
        backgroundImage: "url(./images/d3_sous_chef.png)",
        backgroundPosition: "center",
        backgroundRepeat: "no-repeat"
      }}
    />
